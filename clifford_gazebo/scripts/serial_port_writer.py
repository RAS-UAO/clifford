...
class SerialPortWriter(Node):
    ...
    def joint_states_callback(self, joint_states_msg):
        ...
        front_left_q1_in_bits = 200.0
        front_left_q2_in_bits = self.map_position_into_bits(front_left_q2_in_degrees, -200,200, 0, 1023)
        front_left_q3_in_bits = self.map_position_into_bits(front_left_q3_in_degrees, -200,200, 0, 1023)
        back_left_q1_in_bits = 200.0
        back_left_q2_in_bits = self.map_position_into_bits(back_left_q2_in_degrees, -200,200, 0, 1023)
        back_left_q3_in_bits = self.map_position_into_bits(back_left_q3_in_degrees, -200,200, 0, 1023)
        front_right_q1_in_bits = 200.0
        front_right_q2_in_bits = self.map_position_into_bits(front_right_q2_in_degrees, -200,200, 0, 1023)
        front_right_q3_in_bits = self.map_position_into_bits(front_right_q3_in_degrees, -200,200, 0, 1023)
        back_right_q1_in_bits = 200.0
        back_right_q2_in_bits = self.map_position_into_bits(back_right_q2_in_degrees, -200,200, 0, 1023)
        back_right_q3_in_bits = self.map_position_into_bits(back_right_q3_in_degrees, -200,200, 0, 1023)
